...
- `docs/RUNTIME_IMMEDIATE_ACTIVATION_PRINCIPLE.md`：当天形成的工作流级修正应立即成为当前运行规则，而不是只作为归档知识留待以后参考。
- `docs/REAL_RUN_RUNTIME_IMMEDIATE_ACTIVATION_SAMPLE.md`：对"运行时立即生效原则"做同会话真实样本验证的记录页。
- `docs/PROJECT_ROADMAP_2026-06-27.md`：**项目路线地图**——从基础设施到完整循环的4阶段规划，综合循环文章共识、AI Agent科研范式转变PDF和当前系统状态。
